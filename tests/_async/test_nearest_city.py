...
async def border_geocoder():
    """One AsyncNearestCity reused across all border probe rows."""
...
async def test_cities_close_country_boundaries(case, loaded_countries):
...
async def test_border_fixture_country_assignment(
